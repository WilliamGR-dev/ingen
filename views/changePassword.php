...
<div class="loginRegister">
    ...
    <div>
        <div id="firstForm">
            <form method="post" action="index.php?p=password&action=change" id="formLogin" class="formLogin">
                <div><h2>Modification du mot de passe</h2></div>
                <div>
                    <label>Email : *<br></label>
                    <input type="email" name="email" placeholder="Email"><br>

                    <label>Code de recuperation : *<br></label>
                    ...
                    <input type="text" name="confirmPassword" placeholder="Mot de passe" ><br>
                </div>
                ...
                <?php endif;endif; ?>
                <div>
                    <button class="sumbit" type="submit">Modifier</button>
                </div>
            </form>
        </div>
    </div>
