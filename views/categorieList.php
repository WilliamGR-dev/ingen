...
<div style="min-height: 90vh;display: flex;flex-direction: column;align-items: center;justify-content: flex-start;">
    <div class="profil">
        ...
        <div class="userInformation">
            ...
            <a href="index.php?admin=categories&action=new"> Ajouter</a>
            ...
            <table class="userList">
                ...
                <?php foreach($categories as $category): ?>
                    <tr>
                        <td><?=  $category['id'] ?></td>
                        <td><?=  $category['name'] ?></td>
                        <td><img style="width: 64px;height: 64px" src="./assets/img/<?=  $category['img'] ?>"></td>
                        <td>
                            <a href="index.php?admin=categories&action=edit&id=<?= $category['id'] ?>">modifier</a>
                            <a href="index.php?admin=categories&action=delete&id=<?= $category['id'] ?>">supprimer</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </table>
