...
<div style="min-height: 90vh;display: flex;flex-direction: column;align-items: center;justify-content: flex-start;">
    <div class="profil">
        ...
        <div class="userInformation">
            ...
            <form action="index.php?admin=productColor&action=<?= isset($colorSelected) ? 'edit&id='.$colorSelected['id'] : 'add' ?>" method="post" enctype="multipart/form-data">

                <label for="name">Nom :</label>
                <input  type="text" name="name" id="name" value="<?php if(isset($_SESSION['old_inputs'])):?><?= isset($_SESSION['old_inputs']) ? $_SESSION['old_inputs']['last_name'] : ''; ?><?php else: ?><?= isset($colorSelected) ? $colorSelected['name'] : '';  endif;?>" /><br>

                <label for="name">image 30*30 :</label>
